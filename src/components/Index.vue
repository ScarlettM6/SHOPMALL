<template>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="seckill">
        ...
        <div class="seckill-head">
          <div class="seckill-icon">
            <img src="static/img/index/GO.jpg">
          </div>
          <div class="seckill-text">
            <span class="seckill-title">聚划算</span>
            <span class="seckill-remarks"> 不用算 真便宜</span>
          </div>
          <div class="count-down">
            <span class="count-down-text">百亿补贴 大牌正品 买贵必赔</span>
          </div>
        </div>
        <!-- 内容 -->
      ...
      <div class="goodTing">
    <div  class="goodImg">
      <img height="30px" src="../../static/img/goodThing.png" alt="">与品质生活不期而遇
    </div>
      <Row >
          <Col class="hover" span="4"><img width="100%" src="../../static/img/index/1.jpg" alt=""> </Col>
          <Col class="hover" span="4"><img width="100%" src="../../static/img/index/2.jpg" alt=""> </Col>
          <Col class="hover" span="4"><img width="100%" src="../../static/img/index/3.jpg" alt=""> </Col>
          <Col class="hover" span="4"><img width="100%" src="../../static/img/index/4.jpg" alt=""> </Col>
          <Col class="hover" span="4"><img width="100%" src="../../static/img/index/5.jpg" alt=""> </Col>
          <Col class="hover" span="4"><img width="100%" src="../../static/img/index/6.jpg" alt=""> </Col>
     </Row>
...
.seckill-head {
  width: 100%;
  height: 50px;
  background-image: linear-gradient(to #8470FF, #B0C4DE , #EEE8AA);
...
.item-class-head {
  width: 100%;
  height: 50px;
  background-image: linear-gradient(to right,  #FD2654,#ECB226);
